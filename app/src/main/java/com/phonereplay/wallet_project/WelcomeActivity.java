...
public class WelcomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**
         * Listener para o botão "createWalletButton".
         * Este método é chamado quando o botão de criação de carteira é pressionado.
         * Ele realiza os seguintes passos:
         * 1. Gera entropia aleatória para criar uma seed determinística.
         * 2. Utiliza a seed para criar uma carteira determinística compatível com BIP-32.
         * 3. Salva a carteira gerada em um arquivo local.
         * 4. Exibe um modal ao concluir o processo com sucesso.
         *
         * Requisitos:
         * - Biblioteca `bitcoinj` para manipulação de carteiras e chaves privadas.
